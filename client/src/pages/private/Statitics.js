...
import { apiGetDashBoard, apiGetProductsAdmin } from '../../apis/product'
                ...
                <div className='flex gap-4 items-center'>
                    <div className='flex-1 border bg-white rounded-md shadow-md flex p-4 items-center justify-between'>
                        <span className='flex flex-col'>
                            <span className='text-[24px] text-main'>{data?.visited || 0}</span>
                    ...
                    <div className='flex-1 border bg-white rounded-md shadow-md flex p-4 items-center justify-between'>
                        <span className='flex flex-col'>
                            <span className='text-[24px] text-main'>{data?.soldProducts || 0}</span>
                    ...
                    <div className='flex-1 border bg-white rounded-md shadow-md flex p-4 items-center justify-between'>
                        <span className='flex flex-col'>
                            <span className='text-[24px] text-main'>
                                <span >{Number((+data?.statusChart?.find(el => el.status === 'Success')?.totalsBill || 0)?.toFixed(1)).toLocaleString()}</span>
                    ...
                    <div className='w-[70%] border shadow-md flex flex-col gap-4 relative rounded-md flex-auto p-4'>
                        <div className='flex items-center justify-between'>
                            <span className='font-bold flex items-center gap-8'>
                                <span>{`Số sản phẩm đã bán theo ${isMonth ? 'tháng' : 'ngày'}`}</span>
